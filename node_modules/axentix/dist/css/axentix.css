...
/*** Mixins ***/
/*** Functions ***/
/*** Here are defined all variables that was used by Axentix scss files ***/
...
.navbar .navbar-menu .navbar-link:hover, .navbar .navbar-menu .navbar-link.active {
...
.layout.with-sidenav.fixed-sidenav.under-navbar .layout-header {
...
.layout.with-sidenav.fixed-sidenav.under-navbar.sidenav-right .layout-header {
...
.layout.with-sidenav.fixed-sidenav .layout-header,
.layout.with-sidenav.fixed-sidenav main,
.layout.with-sidenav.fixed-sidenav .layout-main {
    padding-left: 12rem;
  }
...
.layout.with-sidenav.fixed-sidenav .layout-footer {
    padding-left: 12.5rem;
  }
  .layout.with-sidenav.fixed-sidenav.sidenav-right header,
.layout.with-sidenav.fixed-sidenav.sidenav-right .layout-header,
.layout.with-sidenav.fixed-sidenav.sidenav-right main,
.layout.with-sidenav.fixed-sidenav.sidenav-right .layout-main {
    padding-right: 12rem;
    padding-left: 0;
  }
...
.layout.with-sidenav.fixed-sidenav.sidenav-right .layout-footer {
    padding-right: 12.5rem;
    padding-left: 0.5rem;
  }
  .layout.with-sidenav.fixed-sidenav.sidenav-both header,
.layout.with-sidenav.fixed-sidenav.sidenav-both .layout-header,
.layout.with-sidenav.fixed-sidenav.sidenav-both main,
.layout.with-sidenav.fixed-sidenav.sidenav-both .layout-main {
    padding-right: 12rem;
    padding-left: 12rem;
  }
...
.layout.with-sidenav.fixed-sidenav.sidenav-both .layout-footer {
    padding-right: 12.5rem;
    padding-left: 12.5rem;
  }
...
.layout.with-sidenav.fixed-sidenav.sidenav-large .layout-header,
.layout.with-sidenav.fixed-sidenav.sidenav-large main,
.layout.with-sidenav.fixed-sidenav.sidenav-large .layout-main {
    padding-left: 15rem;
  }
...
.layout.with-sidenav.fixed-sidenav.sidenav-large .layout-footer {
    padding-left: 15.5rem;
  }
  .layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-right header,
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-right .layout-header,
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-right main,
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-right .layout-main {
    padding-right: 15rem;
    padding-left: 0;
  }
...
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-right .layout-footer {
    padding-right: 15.5rem;
    padding-left: 0.5rem;
  }
  .layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both header,
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both .layout-header,
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both main,
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both .layout-main {
    padding-right: 15rem;
    padding-left: 15rem;
  }
...
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both .layout-footer {
    padding-right: 15.5rem;
    padding-left: 15.5rem;
  }
  .layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both.sidenav-large-right header,
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both.sidenav-large-right .layout-header,
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both.sidenav-large-right main,
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both.sidenav-large-right .layout-main {
    padding-left: 12rem;
  }
...
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both.sidenav-large-right .layout-footer {
    padding-left: 12.5rem;
  }
  .layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both.sidenav-large-left header,
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both.sidenav-large-left .layout-header,
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both.sidenav-large-left main,
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both.sidenav-large-left .layout-main {
    padding-right: 12rem;
  }
...
.layout.with-sidenav.fixed-sidenav.sidenav-large.sidenav-both.sidenav-large-left .layout-footer {
    padding-right: 12.5rem;
  }
}
.card .table {
...
.table.border-0 td,
.table.border-0 th, .table.striped td,
.table.striped th {
  border: none;
}
...
.btn [class*=hoverable-]:not(.press), .btn [class*=hoverable-]:not(.outline),
...
.btn.disabled.outline, .btn[disabled].outline {
  border-color: #c8c8c8;
}
.btn.outline {
...
.btn-group:not(.btn-group-vertical) .outline:not(:first-child) {
  border-left-width: 1px;
}
.btn-group:not(.btn-group-vertical) .outline:not(:last-child) {
  border-right-width: 1px;
}
...
.btn-group.btn-group-vertical .outline:not(:first-child) {
  border-top-width: 1px;
}
.btn-group.btn-group-vertical .outline:not(:last-child) {
  border-bottom-width: 1px;
}
.btn-group .btn {
...
.sidenav .sidenav-link:hover, .sidenav .sidenav-link.active {
  background-color: rgba(0, 0, 0, 0.15);
}
.sidenav .divider {
  margin: 0.2rem 0;
...
.sidenav .collapsible a:hover, .sidenav .collapsible a.active {
...
@media screen and (max-width: 959px) {
  ...
  .toaster.toaster-m-top {
    flex-direction: column;
    bottom: unset;
    top: var(--toaster-m-offset) !important;
    align-items: unset;
  }
...
.toaster .toast.loading::after {
  content: "";
  position: absolute;
  transition-duration: var(--toast-loading-duration);
  transition-property: width;
  transition-timing-function: ease;
  border-bottom: var(--toast-loading-border);
  width: 0%;
  left: 0;
  bottom: 0;
}
.toaster .toast.loading.load::after {
  width: 100%;
}
...
.form-material .form-field:not(.form-default) .form-control[disabled], .form-material .form-field:not(.form-default) .form-control[readonly] {
  background: transparent !important;
  color: #787878 !important;
  border-bottom: #c7c7c7 dashed thin !important;
}
.form-material .form-field:not(.form-default) .form-control[disabled] + label, .form-material .form-field:not(.form-default) .form-control[readonly] + label {
  color: #787878;
}
.form-material .form-field:not(.form-default)::after {
  ...
  left: var(--form-material-left-offset);
  width: 0;
...
.form-material .form-field:not(.form-default).active .form-control[disabled] + label, .form-material .form-field:not(.form-default).active .form-control[readonly] + label {
  color: #787878;
}
...
.form-material .form-field:not(.form-default).active textarea.form-control[disabled] + label, .form-material .form-field:not(.form-default).active textarea.form-control[readonly] + label {
  color: #787878;
}
...
.form-material .form-field:not(.form-default).active.is-txtarea-focused textarea.form-control {
  border-bottom: 0.1rem solid var(--form-material-color) !important;
}
...
.tab .tab-menu {
  ...
  margin: 0;
  padding: 0;
  --tab-bar-border: 0.1rem solid #2196f3;
}
...
.caroulix .caroulix-indicators li:hover, .caroulix .caroulix-indicators li.active {
  opacity: 1;
}
